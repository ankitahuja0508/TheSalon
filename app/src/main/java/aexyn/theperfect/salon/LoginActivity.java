...
public class LoginActivity extends AppCompatActivity implements OnClickListener {
  ...
  public Bitmap blurImage(Bitmap bitmap) {
    ...
    Allocation                     input       = Allocation.createFromBitmap(renderScript, scaledDownBitmap, mipmapFull,
                                                                             usageShared);
  ...
  private class CheckLogin extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... args) {
      ...
      jsonResponse = Defs.jsonParser.makeHttpRequest(Defs.url_validate_login, "GET", params);
