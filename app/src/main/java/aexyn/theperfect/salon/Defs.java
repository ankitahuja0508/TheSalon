...
public class Defs {
  ...
  public static String url_validate_login = server_ip + "franchisee_login.php";

  public static String url_register_user = server_ip + "register_user.php";

  public static String url_get_visitor_names = server_ip + "get_visitor_names.php";

  public static String url_get_visitor_details = server_ip + "get_visitor_details.php";

  public static String url_add_franchisee = server_ip + "add_franchisee.php";

  public static String url_get_locations = server_ip + "get_locations.php";

  public static String url_delete_franchisee = server_ip + "delete_franchisee.php";

  public static String url_activate_franchisee = server_ip + "activate_franchisee.php";

  public static String url_change_pass = server_ip + "change_password.php";
