  ...
  @Override public void onCreate(Bundle savedInstanceState) {
    ...
    lv.setOnItemClickListener(new OnItemClickListener() {
      ...
      @Override public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String phone = ((TextView) view.findViewById(R.id.pid)).getText().toString();

        Intent in = new Intent(getApplicationContext(), DisplayVisitorDetails.class);
        ...
        if (fetched) {
          runOnUiThread(new Runnable() {
            public void run() {
              ...
              ListAdapter adapter = new SimpleAdapter(DisplayVisitorNames.this, visitorsList, R.layout.list_item,
                                                      new String[] { Defs.TAG_PHONE, Defs.TAG_NAME,
                                                                     Defs.TAG_VISIT_COUNT },
